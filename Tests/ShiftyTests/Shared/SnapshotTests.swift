...
class SnapshotTests: XCTestCase {
    ...
    func testSnapshot_equalityDependsOnAllProperties() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
    ...
    func testSnapshot_notEqualWhenCenterDiffers() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: CGPoint(x: 1, y: 1), bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
    ...
    func testSnapshot_notEqualWhenBoundsDiffers() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: CGRect(x: 0, y: 0, width: 100, height: 200), alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        
        XCTAssertNotEqual(snap1, snap2)
    }
    
    func testSnapshot_notEqualWhenAlphaDiffers() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 0.5, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
    ...
    func testSnapshot_notEqualWhenBackgroundColorDiffers() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, backgroundColor: UIColor.white, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
    ...
    func testSnapshot_notEqualWhenTransformDiffers() {
        ...
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: transform, cornerRadius: 0)
    ...
    func testSnapshot_notEqualWhenCornerRadiusDiffers() {
        let snap1 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 0)
        let snap2 = Snapshot(center: .zero, bounds: .zero, alpha: 1, transform3D: CATransform3DIdentity, cornerRadius: 4)
    ...
    func testSnapshot_initializationFromViewCorrectlyStoresProperties() {
        ...
        let snap1 = Snapshot(center: center, bounds: bounds, alpha: alpha, backgroundColor: backgroundColor,
                             transform3D: transform, cornerRadius: cornerRadius)
