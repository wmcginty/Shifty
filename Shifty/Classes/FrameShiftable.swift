...
public protocol CustomFrameShiftable: FrameShiftable {
    ...
    ///
    /// - parameter shifting:   The view that is being shifted. A subview of `containerView`.
    /// - parameter container:  The container of the transition. The source, destination and `shiftingView` are all subviews.
